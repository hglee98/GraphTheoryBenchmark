...
p = pickle.load(open("../data_temp/WL_flex_graphs_100_shell_pca_sub_50.p", "rb"))
...
p = pickle.load(open("../data_temp/WL_flex_graphs_16_shell_pca_sub_250.p", "rb"))
prop_list, name_list = np.array(p['prop_list']), np.array(p['name_list'])
X_low_full = np.array(p['X_low'])
X_low_full.shape

p = pickle.load(open("../data_temp/WL_flex_graphs_36_shell_pca_sub_80.p", "rb"))
prop_list, name_list = np.array(p['prop_list']), np.array(p['name_list'])
X_low_full = np.array(p['X_low'])
X_low_full.shape
